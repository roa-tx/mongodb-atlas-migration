...
central_provider_auto_scaling_compute_max_instance_size = "M10" 
central_one_provider_region_name                        = "US_EAST_1" 
central_one_electable_nodes                             = 1
central_one_priority                                    = 7
central_one_read_only_nodes                             = 0
central_two_provider_region_name                        = "US_WEST_2"
central_two_electable_nodes                             = 1
central_two_priority                                    = 6
central_two_read_only_nodes                             = 0
central_three_provider_region_name                      = "EU_WEST_1"
central_three_electable_nodes                           = 1
central_three_priority                                  = 5
central_three_read_only_nodes                           = 0
